...
<div class='flex-dt'>
  ...
  <section class="half-dt">
    ...
    <Input id={'s-city'} label={'city'} type={'text'} required={true}
      srOnlyLabel={true} placeholder={'City'} bind:value={store.city} />
  </section>
</div>
      ...
      <tr>
        <td>
          <Modal id={s.id || ''} on:confirm={() => save(s)} bind:openModal={modalTrigger[i]}>
            ...
            <div slot="modal">
              <Input id={'s-name'} label={'store name'} type={'text'} required={true}
                srOnlyLabel={true} placeholder={'Store Name'} bind:value={s.name} />
              <Input id={'s-cate'} label={'category'} type={'text'} required={true}
                srOnlyLabel={true} placeholder={'Category'} bind:value={s.category} />
              <Input id={'s-addy'} label={'address'} type={'text'} required={true}
                srOnlyLabel={true} placeholder={'Address'} bind:value={s.address} />
              <Input id={'s-city'} label={'city'} type={'text'} required={true}
...
{:else}
  <p transition:slide|local>If this is your first time, please find and set your closest or preferred source of sustenance...</p>
{/if}
